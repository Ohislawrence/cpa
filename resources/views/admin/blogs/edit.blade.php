...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div id="kt_account_settings_profile_details" class="collapse show">
        <!--begin::Form-->
        <form id="kt_account_profile_details_form" class="form" action="{{ route('admin.blogs.update', ['id' => $blog->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            <!--begin::Card body-->
            ...
            <div class="fv-row mb-10">
                ...
                <!--end::Label-->
                <!--begin::Input-->
                <input name="title" class="form-control form-control-lg form-control-solid" value="{{ $blog->title }}"/>
                <!--end::Input-->
            </div>
            <!--end::Input group-->
            ...
            <!--end::Input group-->
                ...
                <div class="fv-row mb-10">
                    ...
                    <!--end::Label-->
                    <!--begin::Input-->
                    <textarea name="content" id="body" class="form-control form-control-lg form-control-solid" rows="15">
                        {{ $blog->desc }}
                    </textarea>
                    <!--end::Input-->
                </div>
