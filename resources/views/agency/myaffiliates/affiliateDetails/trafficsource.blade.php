@extends('layouts.app')
@section('headername',  'Traffic Source for  ' )
@section('bread1',  'Affiliates' )
@section('bread2',  'traffic Source for ' )
...
<script type="text/javascript">
	...
	var table = $('.yajra-datatable').DataTable({
		...
		processing: true,
		serverSide: true,
		ajax: "{{ route('merchant.gettrafficsource', ['id' => $user->id]) }}",
		columns: [
...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
	...
	<div class="container-xxl" id="kt_content_container">
        ...
        @include('agency.myaffiliates.affiliateDetails.addTrafficSource')
			...
			<div class="card-header border-0 pt-6">
				...
				<div class="card-toolbar">
					...
					<div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
						<!--begin::Add user-->
						<button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#affiliate_trafficsource">
