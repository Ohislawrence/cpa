...
class OfferController extends Controller
{
    ...
    public function index()
    {
        ...
        $payouts = Payout::all();
        return view('admin.offer', compact('offers', 'categories', 'agencies', 'locations', 'payouts'));
    }
    ...
    public function store(Request $request)
    {
        ...
        Target::insert([
            ...
            'url' => ($request->desktopurl) ? $request->desktop : null],
            ['offer_id' => $offer->id,
            'target' => 'iOS',
            'payout' => ($request->ios) ? $request->ios : "0",
            'url' => ($request->iosurl) ? $request->desktop : null],
            ['offer_id' => $offer->id,
            'target' => 'Android',
