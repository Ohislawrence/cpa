                        ...
                        <td align="center" valign="center" style="text-align:center; padding-bottom: 10px">
                            ...
                            <div style="text-align:center; margin:0 60px 34px 60px">
                                ...
                                <div style="text-align:start; font-size: 13px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                                    ...
                                    <p style="margin-bottom:8px; color:#5E6278">We will reach out to you promptly with an update. We aim to communicate our decision via the chat link you provided within the next three days. If you have any questions or concerns in the meantime, please don't hesitate to reach out to us using the same chat link.</p>
