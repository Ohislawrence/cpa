@extends('layouts.app')
@section('headername',  'Affiliates Settings' )
@section('bread1',  'Affiliates' )
@section('bread2',  'Affiliates Settings' )
...
@section('footer')
<!--https://woocommerce.com/document/affiliate-for-woocommerce/settings/-->
@endsection
...
<div class="card mb-9">
    <div class="card-header pt-7">
        <!--begin::Title-->
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold text-gray-800">General</span>
            <span class="text-gray-500 mt-1 fw-semibold fs-6">General Settings</span>
        </h3>
    </div>
    <!--begin::Body-->
    <div class="card-body p-lg-17">
...
<!--begin::Form-->
<form action="m-0" class="form " method="post" id="kt_careers_form">
<!--begin::Input group-->
<div class="row mb-5">
<!--begin::Col-->
<div class="col-md-6 fv-row">
...
<div class="card mb-9">
    <div class="card-header pt-7">
        <!--begin::Title-->
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold text-gray-800">Commission</span>
            <span class="text-gray-500 mt-1 fw-semibold fs-6">Commission Settings</span>
        </h3>
    </div>
    <!--begin::Body-->
    <div class="card-body p-lg-17">
...
<div class="card mb-9">
    <div class="card-header pt-7">
        <!--begin::Title-->
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold text-gray-800">Referral</span>
            <span class="text-gray-500 mt-1 fw-semibold fs-6">Referral Settings</span>
        </h3>
    </div>
    <!--begin::Body-->
    <div class="card-body p-lg-17">
...
<div class="card mb-9">
    <div class="card-header pt-7">
        <!--begin::Title-->
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold text-gray-800">Payout</span>
            <span class="text-gray-500 mt-1 fw-semibold fs-6">Payout Settings</span>
        </h3>
    </div>
    <!--begin::Body-->
    <div class="card-body p-lg-17">
