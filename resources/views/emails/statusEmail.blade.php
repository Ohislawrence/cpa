                ...
                <div style="text-align:center; margin:0 60px 34px 60px">
                    ...
                    <div style="text-align:start; font-size: 13px; font-weight: 500; margin-bottom: 27px; font-family:Arial,Helvetica,sans-serif;">
                        ...
                        <p style="margin-bottom:9px; color:#181C32; font-size: 18px; font-weight:600">Hello {{ $user->name }},</p>
                                    <p style="margin-bottom:8px; color:#5E6278">{{ $theMessage }}</p>
                                    <p style="margin-bottom:8px; color:#5E6278">If you have any questions or need help getting started, feel free to reach out to us. We’re here to support you every step of the way.</p>
